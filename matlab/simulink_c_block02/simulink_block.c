...
void myFunction(const double x_ini[3], double Vsd, double Vsq, double iL, double ref, const double u0[2], double outputVector[4])
{
    ...
    outputVector[0] = u[0];
    outputVector[1] = u[1];
    outputVector[2] = u[0]*vdc*0.5;
    outputVector[3] = u[1]*vdc*0.5;
}
